...
public class ScatterchartController implements Initializable {
    ...
    public void scattertomain(ActionEvent actionEvent) throws IOException {
        Parent scattertoMain= FXMLLoader.load(getClass().getResource("Mainmenu.fxml"));
        Scene scene = new Scene(scattertoMain);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        scatterchart.setTitle("Engineers Salaries");
